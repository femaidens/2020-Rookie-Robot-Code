...
import frc.robot.commands.DriveStraightCom;
...
public class OI {
    ...
    */
    ...
    public static Button driveStraight = new JoystickButton(joy,2);
...
*/
        ...
        driveStraight.whenPressed(new DriveStraightCom(150,.3,.1));
    }
